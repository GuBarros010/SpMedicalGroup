...
VALUES (3,'ricardo.lemos@spmedicalgroup.com.br','123'), 
       (3,'roberto.possarle@spmedicalgroup.com.br','1234'), 
	   (3,'helena.souza@spmedicalgroup.com.br','12345'),
	   (2,'ligia@gmail.com','abc'), 
	   (2,'alexandre@gmail.com','abcd'), 
	   (2,'fernando@gmail.com','abcde'),
	   (2,'henrique@gmail.com','abcdef'), 
	   (2,'joao@hotmail.com','abcdefg'), 
	   (2,'bruno@gmail.com','abcdefgh'), 
	   (2,'mariana@outlook.com','abcdefghi'),
...
VALUES (7, 3 , 1,'Deu tudo certo', '1/12/20 15:00'),
	   ...
	   (7, 3, 3, 'Esperando Resposta', '03/08/2020  15:00:00'),
	   (4, 1, 3, 'Esperando Resposta', '03/09/2020  11:00:00');
GO